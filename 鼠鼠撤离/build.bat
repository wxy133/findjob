...
echo.
echo [3/6] 生成 ICO / 圆形头像 / 横幅素材...
python tools\make_assets.py
if errorlevel 1 (
    echo ❌ 素材生成失败，检查 assets/app_icon.jpg 和 assets/header_banner.jpg
    pause
    exit /b 1
)
...
if exist "鼠鼠撤离.spec" del /q "鼠鼠撤离.spec"

echo.
echo [5/6] 开始打包单文件 EXE（含鼠鼠图标），请耐心等待...
echo.
...
echo ================================================================
echo    ✅ 打包完成！
echo    可执行文件: dist\鼠鼠撤离.exe
echo    桌面图标: 已使用鼠鼠撤离 ICO（16/24/32/48/64/128/256 多尺寸）
echo ================================================================
echo.
echo 💡 使用提示:
