...
# 蓝白清新配色板（米菲经典蓝+白）
PALETTE = {
    "bg_cream":       "#F0F5FF",   # 主背景 - 淡天蓝
    "bg_card":        "#FFFFFF",   # 卡片 - 纯白
    "bg_card_alt":    "#E3EDFA",   # 强调卡片 - 淡蓝
    "bg_drop":        "#E3EDFA",   # 拖放区 - 淡蓝
    "bg_drop_border": "#8AB8E8",   # 拖放区边框
    "bg_log":         "#F5F9FF",   # 日志 - 极淡蓝

    "fg_main":        "#3A4A5C",   # 正文 - 深蓝灰
    "fg_sub":         "#6B7B8D",   # 次要文字
    "fg_hint":        "#9BABBF",   # 提示文字
    "fg_white":       "#FFFFFF",   # 反白

    "primary":        "#4A90D9",   # 主按钮 - 米菲蓝
    "primary_dark":   "#3A7BC8",   # 主按钮按下
    "primary_hover":  "#5DA0E9",
    "success":        "#5BB85B",   # 成功 - 清新绿
    "warning":        "#E8A87C",   # 警告 - 蜜桃橙
    "danger":         "#E06C75",   # 错误 - 粉红
    "info":           "#7B9AB5",   # 普通信息 - 蓝灰
    "accent_amber":   "#B0D4F1",   # 点缀 - 浅蓝
    "divider":        "#D0E0F0",   # 分隔线
}
...
class JobApp:
    def __init__(self, root):
        self.root = root
        self.root.title("米菲跑路 · BOSS直聘自动投递")
    ...
    def _build_header_banner(self):
        if self._header_tk:
            ...
            tk.Label(title_frame,
                     text="拜拜啦！提起小篮子去投新简历  🐰  简历解析 → BOSS直聘自动投递",
                     font=('Microsoft YaHei UI', 10),
                     fg=PALETTE["fg_sub"],
            ...
            ttk.Label(header, text="🐰  米菲跑路", style='Title.TLabel').pack(side=tk.LEFT)
    ...
    def _start_apply(self):
        ...
        self._append_log(f"🐰 米菲提起了小篮子，冲鸭！开始为「{keyword}」在 {city} 自动投递...")
